  ...
  theme: {
    extend: {
      boxShadow: {
        ...
        'win98-clock':
          '0 2px white, 0 -2px #7d7d7d, -2px -2px #7d7d7d, 2px 2px white, -2px 2px #7d7d7d, 2px -2px white;',
      },
      colors: {
        yellow: '#efc603',
        grey: '#c0c0c0',
      ...
      backgroundImage: {
        book: "url('/src/images/icons/book.png')",
        paint: "url('/src/images/icons/paint.png')",
        certificate: "url('/src/images/icons/certificate.png')",
      },
      keyframes: {
        typing: {
          '0%, 100%': { width: '0%' },
